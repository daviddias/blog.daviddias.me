...
One of the tools we can use for therecon is [`DirBuster`](https://www.owasp.org/index.php/Category:OWASP_DirBuster_Project), a Web Application endpoint enumeration tool, now part of the [`OWASP ZAP Attack Proxy`](https://www.owasp.org/index.php/ZAP). 
